    ...
    methods: {
        ...
        addProduct(product) {
            this.getJson(`${API}/addToBasket.json`)
                .then(data => {
                    if (data.result === 1) {
                        let find = this.cart.find(i => i.id_product === product.id_product);
                        if (find) {
                            find.quantity++;
                        } else {
...
// class Item {
//     constructor(el, img = 'https://cdn11.bigcommerce.com/s-jav5lin/images/stencil/1280x1280/products/149304/145936/No%20Image__42523.1550771548.jpg') {
...
//                         document.querySelector('.btn-cart').classList.toggle('invisible');
//                         this.render();
//                     }
//                 } else {
//                     alert('Error');
...
//                             document.querySelector('.btn-cart').classList.toggle('invisible');
//                             // toggle added for closing carts div
//                         }
//                     }
